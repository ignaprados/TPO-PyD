...
public class testPendienteDePago {
    ...
    public void testPagarReserva() {
        assertEquals(reserva.getFactura(), null);

        reserva.getEstado().pagarReserva();

        assertTrue(reserva.getEstado() instanceof Pagada);
        assertTrue(reserva.getFactura() instanceof Factura);
    }

    @Test
    public void testCancelarReserva() {
        assertTrue(reserva.getActiva());

        reserva.getEstado().cancelarReserva();

        assertTrue(reserva.getEstado() instanceof Cancelada);
        assertFalse(reserva.getActiva());
    }
